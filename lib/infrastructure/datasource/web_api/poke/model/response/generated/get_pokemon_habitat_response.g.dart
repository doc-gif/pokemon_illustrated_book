...
_$GetPokemonHabitatResponseImpl _$$GetPokemonHabitatResponseImplFromJson(
...
Map<String, dynamic> _$$GetPokemonHabitatResponseImplToJson(
        _$GetPokemonHabitatResponseImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
