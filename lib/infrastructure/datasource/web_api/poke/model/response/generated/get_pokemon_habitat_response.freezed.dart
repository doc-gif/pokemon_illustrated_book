...
part of '../get_pokemon_habitat_response.dart';
...
GetPokemonHabitatResponse _$GetPokemonHabitatResponseFromJson(
    Map<String, dynamic> json) {
  return _GetPokemonHabitatResponse.fromJson(json);
}

/// @nodoc
mixin _$GetPokemonHabitatResponse {
  ...
  @JsonKey(ignore: true)
  $GetPokemonHabitatResponseCopyWith<GetPokemonHabitatResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetPokemonHabitatResponseCopyWith<$Res> {
  factory $GetPokemonHabitatResponseCopyWith(GetPokemonHabitatResponse value,
          $Res Function(GetPokemonHabitatResponse) then) =
      _$GetPokemonHabitatResponseCopyWithImpl<$Res, GetPokemonHabitatResponse>;
  @useResult
  $Res call(
      {int id,
      String name,
...
/// @nodoc
class _$GetPokemonHabitatResponseCopyWithImpl<$Res,
        $Val extends GetPokemonHabitatResponse>
    implements $GetPokemonHabitatResponseCopyWith<$Res> {
  _$GetPokemonHabitatResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetPokemonHabitatResponseImplCopyWith<$Res>
    implements $GetPokemonHabitatResponseCopyWith<$Res> {
  factory _$$GetPokemonHabitatResponseImplCopyWith(
          _$GetPokemonHabitatResponseImpl value,
          $Res Function(_$GetPokemonHabitatResponseImpl) then) =
      __$$GetPokemonHabitatResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$GetPokemonHabitatResponseImplCopyWithImpl<$Res>
    extends _$GetPokemonHabitatResponseCopyWithImpl<$Res,
        _$GetPokemonHabitatResponseImpl>
    implements _$$GetPokemonHabitatResponseImplCopyWith<$Res> {
  __$$GetPokemonHabitatResponseImplCopyWithImpl(
      _$GetPokemonHabitatResponseImpl _value,
      $Res Function(_$GetPokemonHabitatResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetPokemonHabitatResponseImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$GetPokemonHabitatResponseImpl
    with DiagnosticableTreeMixin
    implements _GetPokemonHabitatResponse {
  const _$GetPokemonHabitatResponseImpl(
      {required this.id,
      required this.name,
  ...
  factory _$GetPokemonHabitatResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$GetPokemonHabitatResponseImplFromJson(json);
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GetPokemonHabitatResponse(id: $id, name: $name, names: $names, pokemonSpecies: $pokemonSpecies)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'GetPokemonHabitatResponse'))
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetPokemonHabitatResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetPokemonHabitatResponseImplCopyWith<_$GetPokemonHabitatResponseImpl>
      get copyWith => __$$GetPokemonHabitatResponseImplCopyWithImpl<
          _$GetPokemonHabitatResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetPokemonHabitatResponseImplToJson(
      this,
    );
  }
}

abstract class _GetPokemonHabitatResponse implements GetPokemonHabitatResponse {
  const factory _GetPokemonHabitatResponse(
  ...
  factory _GetPokemonHabitatResponse.fromJson(Map<String, dynamic> json) =
      _$GetPokemonHabitatResponseImpl.fromJson;
